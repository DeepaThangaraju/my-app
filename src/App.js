...
},
{
  ...
  return (
    ...
    <div className="App" >
     ...
     {movieList.map(nm=>  <Msg names={nm.movieName} image={nm.poster} rate={nm.rating} des={nm.description} />)}  
...
function Msg({names,image,rate,des}){       //unwrapping the name and pc from object
  ...
  return (<div className="movies">
    ...
    <p>Rating:{rate}</p>
    <p>Description:</p><textarea>{des}</textarea>
